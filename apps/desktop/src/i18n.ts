...
const MESSAGES = {
  en: {
    ...
    metadata: "Metadata",
    metadataFormatHelp:
      "Use one KEY=VALUE pair per line. Empty lines are ignored.",
    account: "Account",
    ...
    importedCatalogSearchEmpty:
      "No imported references match the current search",
    importedCatalogSelectHint:
      "Select an imported resource from the tree to inspect or edit its metadata.",
    importedCatalogSearchPlaceholder:
  ...
  "zh-CN": {
    ...
    metadata: "元信息",
    metadataFormatHelp: "每行一条 KEY=VALUE，空行会自动忽略。",
    account: "账号",
    accountId: "账号 ID",
    vault: "Vault",
    item: "条目",
    ...
    importedCatalogSearchEmpty: "当前搜索条件下没有匹配的导入引用",
    importedCatalogSelectHint:
      "从左侧树中选择一个已导入资源，然后查看或编辑它的元信息。",
    importedCatalogSearchPlaceholder:
